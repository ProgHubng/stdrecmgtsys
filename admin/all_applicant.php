 				...
 				<div class="box box-danger">
 					...
 					<div class="box-body">
 						<table class="table table-boredered table-striped table-hover">
 							...
 							<tbody>
 								<?php 
 									$stmt = $db->prepare("SELECT * FROM application WHERE level =:level");
 									$stmt->execute(array('level' => '100L'));
 									while ($rs = $stmt->fetch()) 
 									{
 										?>
 											<tr>
	 											...
	 											<!-- <td size="2"><a href="results.php?id=<?php echo $rs['id']; ?>" class="btn btn-warning" >Upload Result</a></td> -->
 											</tr>
 										<?php
 									}
 									$stmt->closeCursor();
