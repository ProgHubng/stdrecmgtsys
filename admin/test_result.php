<?php 
	$page_title = "Uploading Student Test Result";
    ...
    if (isset($_POST['import'])) {
          ...
          if(in_array($_FILES["upl"]["type"],$mimes)){
            ...
            foreach ($Reader as $value) {
                    ...
                    $in = $db->query("INSERT INTO test_result(matric_no,session,faculty,dept,semester,level,course_title,course_code,course_unit,test_score)VALUES('$matric_no','$session','$faculty','$dept','$semester','$level','$course_title','$course_code','$course_unit','$test_score')");
